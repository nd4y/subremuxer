...
В `Dockerfile` намеренно нет инструкции `VOLUME`: Railway считает такой Dockerfile
недопустимым и отклоняет сборку до её начала. Тома задаются средствами платформы.
