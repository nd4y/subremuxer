...
определение ОС и хоста, подсветку синтаксиса, разрешение сессии по 401, экран входа и
переключение ролей admin/viewer, включая то, что реально видит читатель в карточке профиля.
