...
Главный сценарий: подключить клиент, который сам не умеет отправлять HWID. Поэтому по
умолчанию профиль создаётся с включённой мимикрией — панель видит **Happ на Google Pixel 9**,
а не то, чем вы пользуетесь на самом деле.

Выбираются двумя списками: **клиент** (Happ, v2RayTun, Streisand, sing-box, Karing, Hiddify,
Clash Verge/Mihomo, FlClash, Stash, Shadowrocket, v2rayN, v2rayNG, Throne, браузер) и
**устройство** (Pixel 9 и 9 Pro, Galaxy S24 Ultra, Xiaomi 14, iPhone 16 Pro, iPhone 14 Pro Max,
iPad Pro, ПК на Windows 11, Mac). Любое поле можно дописать вручную. Рядом с выбором клиента
показано, какой формат подписки панель отдаст в ответ.
...
Встроенные, они же восстановимые в один клик: мимикрия под Happ на Pixel 9 и на iPhone,
Happ + только зарубежные, Happ + мобильные каналы, «заставить панель отдать sing-box»,
«заставить панель отдать Clash/Mihomo», и «без мимикрии» как чистая отправная точка.
